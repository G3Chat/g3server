...
public class UserManager implements IQResultListener {
    ...
    public Collection<User> findG3chatUsers(String city)
    	throws UnsupportedOperationException
	{
    	return provider.findUsersByCity(city);
	}
    ...
    public Collection<User> findG3chatUsers(String city, int startIndex,
            int numResults)
            throws UnsupportedOperationException
    {
        return provider.findUsersByCity(city, startIndex, numResults);
    }
